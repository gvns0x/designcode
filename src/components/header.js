...
<HeaderDiv>
    <Content>
      ...
      <Text top={"16px"}bot={"24px"} right={"54px"}>
        <p style={styles.textStyles.textNormal}><span style={styles.textStyles.textBold}>I am a Digital Product Designer</span> from Portugal, currently living in Porto. In the last 2 years I've worked as a designer for both startups and big companies from many parts of the world.</p>
      </Text>
      <Text>
